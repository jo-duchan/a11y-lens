...
When writing or modifying UI code (JSX/TSX/HTML/Vue/Svelte), apply the rule set in `node_modules/@joduchan/a11y-lens/rules/` — read the relevant category before implementing:
